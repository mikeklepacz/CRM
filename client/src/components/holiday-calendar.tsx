...
import { CalendarIcon, Trash2, Loader2, Calendar as CalendarLucide, Building2 } from "lucide-react";
...
export function HolidayCalendar() {
  ...
  const isLoading = isLoadingUpcoming || isLoadingCustom;
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Manage blocked dates for email and call outreach. Federal holidays and extended windows are automatically included.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="text-sm text-muted-foreground border-t pt-4">
          <p className="font-medium mb-2">Automatically Blocked Periods:</p>
          <ul className="list-disc list-inside space-y-1">
            <li>All US Federal Holidays</li>
            <li>Thanksgiving Extended Window (Wednesday before through Sunday after)</li>
            <li>Christmas Extended Window (December 23-26)</li>
            <li>New Year's Extended Window (December 31 - January 2)</li>
