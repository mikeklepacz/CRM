...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, enableEnterSubmit = true, onKeyDown, ...props }, ref) => {
  const handleKeyDown = React.useCallback((e: React.KeyboardEvent<HTMLDivElement>) => {
    ...
    if (e.key === 'Enter' && !e.defaultPrevented) {
      ...
      const primaryButton = dialogContent.querySelector<HTMLButtonElement>(
