...
export function SuperAdminCategoriesTab(props: any) {
  const p = props;
    ...
    <TabsContent value="categories">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage categories - Per tenant settings</CardDescription>
          <div className="pt-2">
        ...
        <CardContent>
          {p.configTenantId === "all" ? (
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p className="text-sm">Select a tenant to manage their categories</p>
            </div>
          ) : (
            <CategoryManagement />
          )}
