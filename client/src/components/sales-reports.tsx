...
import { FileDown, Loader2, Calendar, Users } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Agents earning commissions from referrals
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoadingReferrals ? (
          ...
          ) : !referralData?.referralCommissions || referralData.referralCommissions.length === 0 ? (
            ...
            <div className="rounded-md border">
              <Table>
                ...
                <TableBody>
                  {referralData.referralCommissions.map((referral) => (
