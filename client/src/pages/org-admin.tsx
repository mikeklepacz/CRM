...
export default function OrgAdmin() {
  ...
  const viewProps = {
    ...
    handleProjectSubmit, handleSettingsSubmit, handleStageSubmit, inviteForm, invitesLoading, isCreateUserDialogOpen,
    ...
    setSelectedPipelineId, setUserToRemove, settingsData, settingsForm, settingsLoading, stageForm, statsData, statsLoading,
