...
export async function resolveAdminWindow(
  ...
  return {
    ...
    // Already stored as hours in database (e.g., 1.00 = 1 hour after opening)
    clientWindowStartOffset: parseFloat(ehubSettings?.clientWindowStartOffset?.toString() ?? '1.00'),
