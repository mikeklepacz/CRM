...
/**
 * Cleans up reminders whose Google Calendar events have been deleted.
 * This is a safety net for when webhooks lapse — on login, we verify that
 * each reminder's linked calendar event still exists. If it's gone, we delete the DB reminder.
 */
